var MultiplayerScene = cc.Scene.extend({
    onEnter:function () {
        ...
        var statusLayer =  new StatusLayer(true);
        var layer = new AnimationMultipleLayer(this.space, statusLayer);
        this.addChild(layer);
        ...
        this.splitSprite = cc.Sprite.create();
        this.splitSprite.color = cc.color(10,10,10,255);
        this.splitSprite.setTextureRect(cc.rect(0, 0, 6, winsize.height));
        this.splitSprite.setOpacity(255);
